...
<body>
    ...
    <main class='home'>
        <div class="home__hero">
            <div>
                <h1>Знакомтесь с местом, <br>где природа <br>сплетается с культурой</h1>
        ...
        <div class="home__tours">
            ...
            <div class="popup" style="display: none;">
                ...
                <form id="excursionForm" class="popup__form" action="" method="post">
                    <div class="personalData">
                        <h3>Контактные данные</h3>

                        <label for="firstName">Имя*</label>
                        <input type="text" name="firstName" placeholder="Иван" minlength="2" pattern="^([А-Я]{1}[а-яё]{1,23}|[A-Z]{1}[a-z]{1,23})$" required>

                        <label for="lastName">Фамилия*</label>
                        <input type="text" name="lastName" placeholder="Иванович" pattern="^([А-Я]{1}[а-яё]{1,23}|[A-Z]{1}[a-z]{1,23})$" required>

                        <label for="phone">Телефон*</label>
                        <input type="tel" name="phone" placeholder="+375XXXXXXXXX" pattern="^(\+375|80)(29|25|44|33)(\d{3})(\d{2})(\d{2})$" required>

                        <label for="email">Почта*</label>
                        <input type="email" name="email" placeholder="email@gmail.com" pattern="/^[A-Z0-9._%+-]+@[A-Z0-9-]+.+.[A-Z]{2,4}$/i" required>
        ...
        <div class="popup__tour" style="display: none;"></div>
        <div class="home__cta">
            <div>
        ...
        <div class="home__about">
            ...
            <div class="content">
                <div class="home__about-photo">
                    <img src="/img/about_photo1.jpg" alt="">
                    <div>
